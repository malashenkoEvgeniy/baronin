                    ...
                    <form action="{{route('price.update',$table->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-5">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Заголовок поля</span>
                            </div>
                            <input type="text" class="form-control" name="header" value="{{$table->header}}">
                        </div>
                        <div class="input-group mb-5">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-5">
                            ...
                            <input type="text" class="form-control" name="cost"  value="{{$table->cost}}">
                        </div>
                        <div class="input-group mb-5">
                            <div class="input-group-prepend">
                                <span class="input-group-text">Еденицы измерения</span>
                            </div>
                            <input type="text" class="form-control" name="units"  value="{{$table->units}}">
                        </div>
